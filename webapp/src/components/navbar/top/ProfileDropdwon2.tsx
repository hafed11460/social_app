...
const ProfileDropdwon2 = () => {
    ...
    return (
        <Dropdown navbar={true} as="li" className="menu-item">
            <Dropdown.Toggle
                bsPrefix="toggle"
                as={Link}
                to="#!"
            // className="p-0 px-3 "
            >
                <div className='d-flex menu-link align-self-center p-0'>
                    <div>
...
export default ProfileDropdwon2;